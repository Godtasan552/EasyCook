...
class _DetailPageState extends State<DetailPage> {
  ...
  Future<void> _loadTranslations() async {
    if (_isLoadingTranslations) return;
    ...
    try {
      if (Get.locale?.languageCode == 'th') {
        ...
        // แปล measurements แยกต่างหาก
        for (int i = 0; i < meal.measurements.length; i++) {
          final measurement = meal.measurements[i];
          if (measurement.isNotEmpty) {
            meal.measurements[i] = await TranslationService.to.translateToThai(
              measurement,
            );
          }
        }
  ...
  List<String> _parseInstructions(String instructions) {
    ...
    if (instructions.length > 150) {
      ...
      for (String word in words) {
        if (currentChunk.length + word.length > 120 &&
                        ...
                        Container(
                          ...
                          child: PopupMenuButton<String>(
                            ...
                            onSelected: (String languageCode) async {
                              ...
                              // เคลียร์ cache และแปลใหม่
                              if (Get.isRegistered<TranslationService>()) {
                                TranslationService.to.clearCache();
                              }

                              // เคลียร์การแปลเดิมใน meal object
                              meal.clearTranslations();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    _buildSectionHeader(
                                      ...
                                      subtitle: 'items_count'.trParams({
                                        'count':
                                            '${meal.displayIngredients.length}',
                                      }),
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: List.generate(
                                          ...
                                          (index) {
                                            final ingredient =
                                                meal.displayIngredients[index];
                                            final measurement =
                                                index < meal.measurements.length
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          ...
                                          print(
                                            'Opening YouTube: ${meal.strYoutube}',
                                          );
                                        },
                                        child: Padding(
